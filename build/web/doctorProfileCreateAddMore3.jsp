                    ...
                    <div class="row mrgn30">
                        ...
                        <form method="post" action="profilecreated" id="doctorProfileHospitalInfoForrm" role="form">
                            <div id="doctorProfileHospitalInfo">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="day" id="day" required>
                                            <option value="">Select</option>
                                            <%for(int i=0; i<daysArray.size(); i++){%><option value="<%= daysArray.get(i) %>"><%= daysArray.get(i) %></option><%} %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" name="visitingHours" id="visitingHours" placeholder="Visiting Hours From?" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="visitingHours2">
                                            What are your visiting hours TO? *
                                        </label>
                                        <input type="time" class="form-control" name="visitingHours2" id="visitingHours2" placeholder="Visiting Hours To?" required>
                                    </div><br><br>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <!--<input id="back" class="btn btn-lg btn-primary" type="button" value="Back" onClick="location.href='profile3'" />-->
