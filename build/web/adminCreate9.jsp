                            ...
                            <li class="active" id="firstLink">
                                <div class="dropdown">
                                    ...
                                    <div id="myDropdown" class="dropdown-content">
                                        ...
                                        <a class="scroll-link" title="Symptom">
                                            Symptom
                                        </a>
        ...
        <section id="feedback" class="contact-parlex">
            <div class="parlex-back">
                <div class="container">
                    ...
                    <div class="row mrgn30">
                        <form method="post" action="create9Success" id="createSymptomForm" role="form">
                            <div class="col-sm-4">
                                <div class="search-group">
                                    <label for="symptomTxt">
                                        Symptom: 
                                    </label>
                                    <input type="text" class="search-control" name="symptomTxt" id="symptomTxt" placeholder="Symptom" title="Symptom" required>
                                    <button name="symptomTxtBtn" type="submit" class="btn btn-lg btn-primary" id="SymptomTxtBtn">
                                        Create
                                    </button>
                    ...
                    <div class="row mrgn30">
                        <form method="post" action="update9Success" id="createGenderForm2" role="form">
                            <div class="col-sm-4">
                                <div class="search-group">
                                    <table id="myTable" width="1000">
                                        ...
                                        <tr>
                                            ...
                                            <td id="<%= idForTd%>">
                                                <input type="text" class="form-control" name="<%= id%>"  id="<%= id%>" placeholder="Symptom" title="Sender" value="<%= list.get(i)%>" required readonly >
                                            </td> 
                                            <td id="<%= idForBtn1%>">
