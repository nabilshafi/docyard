...
<html lang="en-gb" class="no-js">
    ...
    <body>
        <%
            ArrayList<String> list = (ArrayList<String>)request.getSession().getAttribute("daysList");
            String idForBtn1 = "";
            String idForBtn2 = "";
            String idForBtn3 = "";
            String idForBtn4 = "";
        ...
        <section id="feedback" class="contact-parlex">
            <div class="parlex-back">
                <div class="container">
                    ...
                    <div class="row mrgn30">
                        <form method="post" action="create6Success" id="createDaysForm" role="form">
                            <div class="col-sm-4">
                                <div class="search-group">
                                    <label for="daysTxt">
                                        Days:
                                    </label>
                                    <input type="text" class="search-control" name="daysTxt" id="daysTxt" placeholder="Days" title="Days" required>
                                    <button name="daysTxtBtn" type="submit" class="btn btn-lg btn-primary" id="daysTxtBtn">
                                        Create
                                    </button>
                    ...
                    <div class="row mrgn30">
                        <form method="post" action="update6Success" id="createGenderForm2" role="form">
                            <div class="col-sm-4">
                                <div class="search-group">
                                    <table id="myTable" width="1000">
                                        <%for(int i=0; i<list.size(); i++) { id = "daysTxt" + Integer.toString(i); idForTd = "td" + Integer.toString(i); idForBtn1 = "td" + Integer.toString(i) + "Btn1"; idForBtn2 = "td" + Integer.toString(i) + "Btn2"; idForBtn3 = "td" + Integer.toString(i) + "Btn3"; idForBtn4 = "td" + Integer.toString(i) + "Btn4";%>
                                        <tr>
                                            <td>
                                                <label for="daysTxt">
                                                    Days: 
                                            ...
                                            <td id="<%= idForTd%>">
                                                <input type="text" class="form-control" name="<%= id%>"  id="<%= id%>" placeholder="Days" title="Sender" value="<%= list.get(i)%>" required readonly >
                                            </td> 
                                            <td id="<%= idForBtn1%>">
