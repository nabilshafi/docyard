...
{   
    public boolean createCity(String crudValue, String filename)
    {
        ...
        try 
        {
            FileReader fr = new FileReader(filename + "Cities_Pakistan.txt");
            ...
            crudValue = crudValue.replace(" ", "_");
            list.add(crudValue);
            FileWriter fw = new FileWriter(filename + "Cities_Pakistan.txt");
...
//            OntClass adminCrudClass = model.getOntClass(Constants.CITY_CLASS_URL);
...
//            fwe.close();
        ...
        {
            System.err.println("Exception occured: CityDAL::create!");
        }
        return success;
    }
    ...
    public boolean create(String crudValue, String filename)
    {
        ...
        {
            Logger.getLogger(CityDAL.class.getName()).log(Level.SEVERE, null, ex);
        }
        return success;
    }
