...
{   
    public boolean createDegree(String crudValue, String filename)
    {
        ...
        try 
        {
            FileReader fr = new FileReader(filename + "Doctors_Types.txt");
            ...
            list.add(crudValue);
            FileWriter fw = new FileWriter(filename + "Doctors_Types.txt");
...
//            OntClass adminCrudClass = model.getOntClass(Constants.DEGREE_CLASS_URL);
...
//            fwe.close();
        ...
        {
            System.err.println("Exception occured: DegreeDAL::create!");
        }
        return success;
    }
    ...
    public boolean create(String crudValue, String filename)
    {
        ...
        {
            Logger.getLogger(DegreeDAL.class.getName()).log(Level.SEVERE, null, ex);
        }
        return success;
    }
