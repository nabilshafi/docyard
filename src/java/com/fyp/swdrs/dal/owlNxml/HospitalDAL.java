...
{   
    public boolean createHospital(String crudValue, String filename)
    {
        ...
        try 
        {
            FileReader fr = new FileReader(filename + "Hospitals_Names.txt");
            ...
            list.add(crudValue);
            FileWriter fw = new FileWriter(filename + "Hospitals_Names.txt");
        ...
        {
            System.err.println("Exception occured: HospitalDAL::create!");
        }
        return success;
    }
    ...
    public boolean create(String crudValue, String filename)
    {
        ...
        {
            Logger.getLogger(HospitalDAL.class.getName()).log(Level.SEVERE, null, ex);
        }
        return success;
    }
