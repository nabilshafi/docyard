...
{   
    public boolean createArea(String crudValue, String filename)
    {
        ...
        try 
        {
            FileReader fr = new FileReader(filename + "Areas_Names.txt");
            ...
            list.add(crudValue);
            FileWriter fw = new FileWriter(filename + "Areas_Names.txt");
...
//            OntClass adminCrudClass = model.getOntClass(Constants.LOCATION_CLASS_URL);
...
//            fwe.close();
        ...
        {
            System.err.println("Exception occured: AreaDAL::create!");
        }
        return success;
    }
    ...
    public boolean create(String crudValue, String filename)
    {
        ...
        {
            Logger.getLogger(AreaDAL.class.getName()).log(Level.SEVERE, null, ex);
        }
        return success;
    }
