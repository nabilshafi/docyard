...
{   
    public boolean createDisease(String crudValue, String filename)
    {
        ...
        try 
        {
            FileReader fr = new FileReader(filename + "Disease_Types.txt");
            ...
            list.add(crudValue);
            FileWriter fw = new FileWriter(filename + "Disease_Types.txt");
...
//            OntClass adminCrudClass = model.getOntClass(Constants.DISEASE_CLASS_URL);
...
//            fwe.close();
        ...
        {
            System.err.println("Exception occured: DiseaseDAL::create!");
        }
        return success;
    }
...
//            Collections.sort(list);
    ...
    public boolean create(String crudValue, String filename)
    {
        ...
        {
            Logger.getLogger(DiseaseDAL.class.getName()).log(Level.SEVERE, null, ex);
        }
        return success;
    }
