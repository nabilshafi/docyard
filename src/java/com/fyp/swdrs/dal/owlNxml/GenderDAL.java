...
{   
    public boolean createGender(String crudValue, String filename)
    {
        ...
        try 
        {
            FileReader fr = new FileReader(filename + "Gender_Types.txt");
            ...
            list.add(crudValue);
            FileWriter fw = new FileWriter(filename + "Gender_Types.txt");
...
//            fwe.close();
        ...
        {
            System.err.println("Exception occured: GenderDAL::create!");
        }
        return success;
    }
...
//            Collections.sort(list);
    ...
    public boolean create(String crudValue, String filename)
    {
        ...
        {
            Logger.getLogger(GenderDAL.class.getName()).log(Level.SEVERE, null, ex);
        }
        return success;
    }
