...
{   
    public boolean createSpecialties(String crudValue, String filename)
    {
        ...
        try 
        {
            FileReader fr = new FileReader(filename + "Specialist_Types.txt");
            ...
            list.add(crudValue);
            FileWriter fw = new FileWriter(filename + "Specialist_Types.txt");
...
//            OntClass adminCrudClass = model.getOntClass(Constants.SPECIALTIES_CLASS_URL);
...
//            fwe.close();
        ...
        {
            System.err.println("Exception occured: SpecialtiesDAL::create!");
        }
        return success;
    }
    ...
    public boolean create(String crudValue, String filename)
    {
        ...
        {
            Logger.getLogger(SpecialtiesDAL.class.getName()).log(Level.SEVERE, null, ex);
        }
        return success;
    }
