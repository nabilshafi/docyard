...
{   
    public boolean createFeedbackQuestion(String crudValue, String filename)
    {
        ...
        try 
        {
            FileReader fr = new FileReader(filename + "FeedbackQuestion_Types.txt");
            ...
            list.add(crudValue);
            FileWriter fw = new FileWriter(filename + "FeedbackQuestion_Types.txt");
...
//            OntClass adminCrudClass = model.getOntClass(Constants.FEEDBACK_QUESTION_CLASS_URL);
...
//            fwe.close();
        ...
        {
            System.err.println("Exception occured: FeedbackQuestionDAL::create!");
        }
        return success;
    }
...
//            Collections.sort(list);
    ...
    public boolean create(String crudValue, String filename)
    {
        ...
        {
            Logger.getLogger(FeedbackQuestionDAL.class.getName()).log(Level.SEVERE, null, ex);
        }
        return success;
    }
