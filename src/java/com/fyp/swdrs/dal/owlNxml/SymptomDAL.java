...
{   
    public boolean createSymptom(String crudValue, String filename)
    {
        ...
        try 
        {
            FileReader fr = new FileReader(filename + "Symptom_Types.txt");
            ...
            list.add(crudValue);
            FileWriter fw = new FileWriter(filename + "Symptom_Types.txt");
        ...
        {
            System.err.println("Exception occured: SymptomDAL::create!");
        }
        return success;
    }
    ...
    public boolean create(String crudValue, String filename)
    {
        ...
        try 
        {
            ...
            OntClass adminCrudClass = model.getOntClass(Constants.SYMPTOM_CLASS_URL);
        ...
        {
            Logger.getLogger(SymptomDAL.class.getName()).log(Level.SEVERE, null, ex);
        }
        return success;
    }
