...
{   
    public boolean createAddress(String crudValue, String filename)
    {
        ...
        try 
        {
            FileReader fr = new FileReader(filename + "Address_Types.txt");
            ...
            list.add(crudValue);
            FileWriter fw = new FileWriter(filename + "Address_Types.txt");
...
//            OntClass adminCrudClass = model.getOntClass(Constants.ADDRESS_CLASS_URL);
...
//            fwe.close();
        ...
        {
            System.err.println("Exception occured: AddressDAL::create!");
        }
        return success;
    }
...
//            Collections.sort(list);
    ...
    public boolean create(String crudValue, String filename)
    {
        ...
        {
            Logger.getLogger(AddressDAL.class.getName()).log(Level.SEVERE, null, ex);
        }
        return success;
    }
