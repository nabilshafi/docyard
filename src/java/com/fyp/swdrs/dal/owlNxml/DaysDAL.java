...
{   
    public boolean createDays(String crudValue, String filename)
    {
        ...
        try 
        {
            FileReader fr = new FileReader(filename + "Days_Names.txt");
            ...
            list.add(crudValue);
            FileWriter fw = new FileWriter(filename + "Days_Names.txt");
...
//            Collections.sort(list);
        ...
        {
            System.err.println("Exception occured: DaysDAL::create!");
        }
        return success;
    }
...
//            Collections.sort(list);
    ...
    public boolean create(String crudValue, String filename)
    {
        ...
        {
            Logger.getLogger(DaysDAL.class.getName()).log(Level.SEVERE, null, ex);
        }
        return success;
    }
