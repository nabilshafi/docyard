                        ...
                        <form method="post" action="feedbacksuccess" id="feedbackfrm" role="form">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <%for(int i=0; i<visitArray.size(); i++){%>
                                        <input type="radio" name="introduction1Answer" value="<%= visitArray.get(i) %>" required>
                                        <%= visitArray.get(i) %>
                                    <%} %> 
                                </div>
                                <div class="form-group">
                                    ...
                                    <%for(int i=0; i<visitArray.size(); i++){%>
                                        <input type="radio" name="introduction2Answer" value="<%= visitArray.get(i) %>" required>
                                        <%= visitArray.get(i) %>
                                    <%} %> 
                                </div>
                                <div class="form-group">
                                    ...
                                    <%for(int i=0; i<visitArray.size(); i++){%>
                                        <input type="radio" name="introduction3Answer" value="<%= visitArray.get(i) %>" required>
                                        <%= visitArray.get(i) %>
                                    <%} %> 
                                </div>
                                <div class="form-group">
                                    ...
                                    <%for(int i=0; i<visitArray.size(); i++){%>
                                        <input type="radio" name="introduction4Answer" value="<%= visitArray.get(i) %>" required>
                                        <%= visitArray.get(i) %>
                                    <%} %> 
                                </div>
                            </div>
                            <div class="col-sm-4">--%>
                                <div class="form-group" id="behaviour1Div">
                                    ...
                                    <%for(int i=0; i<behaviourArray.size(); i++){%>
                                        <input type="radio" name="behaviour1Answer" value="<%= behaviourArray.get(i) %>" required>
                                ...
                                <div class="form-group" id="behaviour2Div">
                                    ...
                                    <%for(int i=0; i<behaviourArray.size(); i++){%>
                                        <input type="radio" name="behaviour2Answer" value="<%= behaviourArray.get(i) %>" required>
                                        <%= behaviourArray.get(i) %>
                                    <%} %> 
                                </div>
                                <div class="form-group" id="behaviour3Div">
                                    ...
                                    <%for(int i=0; i<behaviourArray.size(); i++){%>
                                        <input type="radio" name="behaviour3Answer" value="<%= behaviourArray.get(i) %>" required>
                                        <%= behaviourArray.get(i) %>
                                    <%} %> 
                                </div>
                                <div class="form-group" id="behaviour4Div">
                                    ...
                                    <%for(int i=0; i<behaviourArray.size(); i++){%>
                                        <input type="radio" name="behaviour4Answer" value="<%= behaviourArray.get(i) %>" required>
                                        <%= behaviourArray.get(i) %>
                                    <%} %> 
                                </div>
                                <div class="form-group" id="behaviour5Div">
                                    ...
                                    <%for(int i=0; i<behaviourArray.size(); i++){%>
                                        <input type="radio" name="behaviour5Answer" value="<%= behaviourArray.get(i) %>" required>
                                        <%= behaviourArray.get(i) %>
                                    <%} %> 
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group" id="behaviour6Div">
                                    ...
                                    <%for(int i=0; i<behaviourArray.size(); i++){%>
                                        <input type="radio" name="behaviour6Answer" value="<%= behaviourArray.get(i) %>" required>
                                        <%= behaviourArray.get(i) %>
                                    <%} %> 
                                </div>
                                <!--</div>
                            <div class="col-sm-4">-->
                                <div class="form-group" id="interaction1Div">
                                    ...
                                    <%for(int i=0; i<yesNoArray.size(); i++){%>
                                        <input type="radio" name="interaction1Answer" value="<%= yesNoArray.get(i) %>" required>
                                        <%= yesNoArray.get(i) %>
                                    <%} %> 
                                </div>
                                <div class="form-group" id="interaction2Div">
                                    ...
                                    <%for(int i=0; i<yesNoArray.size(); i++){%>
                                        <input type="radio" name="interaction2Answer" value="<%= yesNoArray.get(i) %>" required>
                                        <%= yesNoArray.get(i) %>
                                    <%} %> 
                                </div>
                                <div class="form-group" id="interaction3Div">
                                    ...
                                    <%for(int i=0; i<yesNoArray.size(); i++){%>
                                        <input type="radio" name="interaction3Answer" value="<%= yesNoArray.get(i) %>" required>
                                        <%= yesNoArray.get(i) %>
                                    <%} %> 
                                </div>
                                <div class="form-group" id="interaction4Div">
                                    ...
                                    <%for(int i=0; i<yesNoArray.size(); i++){%>
                                        <input type="radio" name="interaction4Answer" value="<%= yesNoArray.get(i) %>" required>
                                        <%= yesNoArray.get(i) %>
                                    <%} %> 
                                </div>
                                <div class="form-group" id="interaction5Div">
                                    ...
                                    <%for(int i=0; i<yesNoArray.size(); i++){%>
                                        <input type="radio" name="interaction5Answer" value="<%= yesNoArray.get(i) %>" required>
                                        <%= yesNoArray.get(i) %>
                                    <%} %> 
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group" id="interaction6Div">
                                    ...
                                    <%for(int i=0; i<yesNoArray.size(); i++){%>
                                        <input type="radio" name="interaction6Answer" value="<%= yesNoArray.get(i) %>" required>
                                        <%= yesNoArray.get(i) %>
                                    <%} %> 
                                </div>
                                <div class="form-group" id="interaction7Div">
                                    ...
                                    <%for(int i=0; i<yesNoArray.size(); i++){%>
                                        <input type="radio" name="interaction7Answer" value="<%= yesNoArray.get(i) %>" required>
                                        <%= yesNoArray.get(i) %>
                                    <%} %> 
                                </div>
                                <div class="form-group" id="interaction8Div">
                                    ...
                                    <%for(int i=0; i<yesNoArray.size(); i++){%>
                                        <input type="radio" name="interaction8Answer" value="<%= yesNoArray.get(i) %>" required>
                                        <%= yesNoArray.get(i) %>
                                    <%} %> 
                                </div>
                                <div class="form-group" id="interaction9Div">
                                    ...
                                    <%for(int i=0; i<yesNoArray.size(); i++){%>
                                        <input type="radio" name="interaction9Answer" value="<%= yesNoArray.get(i) %>" required>
                                        <%= yesNoArray.get(i) %>
                                    <%} %> 
                                </div>
                                <!--</div>
                            <div class="col-sm-4">-->
                                <div class="form-group" id="diagnosisTimeDiv">
                                    ...
                                    <%for(int i=0; i<diagnosisArray.size(); i++){%>
                                        <input type="radio" name="diagnosisTimeAnswer" value="<%= diagnosisArray.get(i) %>" required>
                                ...
                                <div class="form-group" id="scaleDiv">
                                    ...
                                    <%for(int i=0; i<scaleArray.size(); i++){%>
                                        <input type="radio" name="scaleAnswer" value="<%= scaleArray.get(i) %>" required>
                                        <%= scaleArray.get(i) %>
                                    <%} %> 
                                </div>
                                <!--<div class="form-group">
