...
<html lang="en-gb" class="no-js">
    ...
    <body>
        <%
            ArrayList<String> list = (ArrayList<String>)request.getSession().getAttribute("areaList");
            String idForBtn1 = "";
            String idForBtn2 = "";
            String idForBtn3 = "";
            String idForBtn4 = "";
                            ...
                            <li class="active" id="firstLink">
                                <div class="dropdown">
                                    ...
                                    <div id="myDropdown" class="dropdown-content">
                                        ...
                                        <a class="scroll-link" title="Area">
                                            Area
                                        </a>
        ...
        <section id="feedback" class="contact-parlex">
            <div class="parlex-back">
                <div class="container">
                    ...
                    <div class="row mrgn30">
                        <form method="post" action="create8Success" id="createAreaForm" role="form">
                            <div class="col-sm-4">
                                <div class="search-group">
                                    <label for="areaTxt">
                                        Area:
                                    </label>
                                    <input type="text" class="search-control" name="areaTxt" id="areaTxt" placeholder="Area" title="Area" required>
                                    <button name="areaTxtBtn" type="submit" class="btn btn-lg btn-primary" id="areaTxtBtn">
                                        Create
                                    </button>
                    ...
                    <div class="row mrgn30">
                        <form method="post" action="update8Success" id="createGenderForm2" role="form" onsubmit="return checkForm(this);">
                            <div class="col-sm-4">
                                <div class="search-group">
                                    <table id="myTable" width="1000">
                                        <%for(int i=0; i<list.size(); i++) { id = "areaTxt" + Integer.toString(i); idForTd = "td" + Integer.toString(i); idForBtn1 = "td" + Integer.toString(i) + "Btn1"; idForBtn2 = "td" + Integer.toString(i) + "Btn2"; idForBtn3 = "td" + Integer.toString(i) + "Btn3"; idForBtn4 = "td" + Integer.toString(i) + "Btn4";%>
                                        <tr>
                                            <td>
                                                <label for="areaTxt">
                                                    Area: 
                                            ...
                                            <td id="<%= idForTd%>">
                                                <input type="text" class="form-control" name="<%= id%>"  id="<%= id%>" placeholder="Area" title="Sender" value="<%= list.get(i)%>" required readonly >
                                            </td> 
                                            <td id="<%= idForBtn1%>">
