...
//            String filename = application.getRealPath("/");
            ArrayList<String> list = (ArrayList<String>)request.getSession().getAttribute("addressList");
            String idForBtn1 = "";
            String idForBtn2 = "";
            String idForBtn3 = "";
            String idForBtn4 = "";
                            ...
                            <li class="active" id="firstLink">
                                <div class="dropdown">
                                    ...
                                    <div id="myDropdown" class="dropdown-content">
                                        ...
                                        <a class="scroll-link" title="Address">
                                            Address
                                        </a>
                                    </div>
                                </div>
        ...
        <section id="feedback" class="contact-parlex">
            <div class="parlex-back">
                <div class="container">
                    ...
                    <div class="row mrgn30">
                        <form method="post" action="create12Success" id="createAddressForm1" role="form">
                            <div class="col-sm-4">
                                <div class="search-group">
                                    <label for="addressTxt">
                                        Address:
                                    </label>
                                    <input type="text" class="search-control" name="addressTxt" id="addressTxt" placeholder="Address" title="Address" required>
                                    <button name="addressTxtBtn" type="submit" class="btn btn-lg btn-primary" id="addressTxtBtn">
                                        Create
                                    </button>
                    ...
                    <div class="row mrgn30">
                        <form method="post" action="update12Success" id="createAddressForm2" role="form">
                            <div class="col-sm-4">
                                <div class="search-group">
                                    <table id="myTable" width="1000">
                                        <%for(int i=0; i<list.size(); i++) { id = "addressTxt" + Integer.toString(i); idForTd = "td" + Integer.toString(i); idForBtn1 = "td" + Integer.toString(i) + "Btn1"; idForBtn2 = "td" + Integer.toString(i) + "Btn2"; idForBtn3 = "td" + Integer.toString(i) + "Btn3"; idForBtn4 = "td" + Integer.toString(i) + "Btn4";%>
                                        <tr>
                                            <td>
                                                <label for="addressTxt">
                                                    Address: 
                                            ...
                                            <td id="<%= idForTd%>">
                                                <input type="text" class="form-control" name="<%= id%>"  id="<%= id%>" placeholder="Address" title="Address" value="<%= list.get(i)%>" required readonly >
                                            </td> 
                                            <td id="<%= idForBtn1%>">
...
//                alert(id2 + ": " + s);
        ...
        function addMore() {
            ...
            cell1.innerHTML = "<label for='addressTxt'>Address: </label>";
            cell2.innerHTML = "<input type='text' class='form-control' name='addressTxt' id='addressTxt' placeholder='Address' title='Address' required >";
            cell2.id = "td" + (x + 1);
...
<!--	<script type="text/javascript">
            function checkForm(form)
            {
                ...
                if(!re.test(form.addressTxt.value)) 
                {
