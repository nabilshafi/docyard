        ...
        <section id="feedback" class="contact-parlex">
            <div class="parlex-back">
                <div class="container">
                    ...
                    <div class="row mrgn30">
                        <form method="post" action="create1Success" id="createGenderForm1" role="form">
                            <div class="col-sm-4">
                                <div class="search-group">
                                    <label for="genderTxt">
                                        Gender:
                                    </label>
                                    <input type="text" class="search-control" name="genderTxt" id="genderTxt" placeholder="Gender" title="Gender" required>
                                    <button name="genderTxtBtn" type="submit" class="btn btn-lg btn-primary" id="genderTxtBtn">
                                        Create
                                    </button>
                    ...
                    <div class="row mrgn30">
                        <form method="post" action="update1Success" id="createGenderForm2" role="form">
                            <div class="col-sm-4">
                                <div class="search-group">
                                    <table id="myTable" width="1000">
                                        <%for(int i=0; i<list.size(); i++) { id = "genderTxt" + Integer.toString(i); idForTd = "td" + Integer.toString(i); idForBtn1 = "td" + Integer.toString(i) + "Btn1"; idForBtn2 = "td" + Integer.toString(i) + "Btn2"; idForBtn3 = "td" + Integer.toString(i) + "Btn3"; idForBtn4 = "td" + Integer.toString(i) + "Btn4";%>
                                        <tr>
                                            <td>
                                                <label for="genderTxt">
                                                    Gender: 
                                            ...
                                            <td id="<%= idForTd%>">
                                                <input type="text" class="form-control" name="<%= id%>"  id="<%= id%>" placeholder="Gender" title="Gender" value="<%= list.get(i)%>" required readonly >
                                            </td> 
                                            <td id="<%= idForBtn1%>">
...
//                alert(id2 + ": " + s);
        ...
        function addMore() {
            ...
            cell1.innerHTML = "<label for='genderTxt'>Gender: </label>";
            cell2.innerHTML = "<input type='text' class='form-control' name='genderTxt' id='genderTxt' placeholder='Gender' title='Gender' required >";
            cell2.id = "td" + (x + 1);
...
<!--	<script type="text/javascript">
            function checkForm(form)
            {
                ...
                if(!re.test(form.genderTxt.value)) 
                {
