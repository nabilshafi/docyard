...
//            String filename = application.getRealPath("/");
            ArrayList<String> list = (ArrayList<String>)request.getSession().getAttribute("diseaseList");
            String idForBtn1 = "";
            String idForBtn2 = "";
            String idForBtn3 = "";
            String idForBtn4 = "";
                            ...
                            <li class="active" id="firstLink">
                                <div class="dropdown">
                                    ...
                                    <div id="myDropdown" class="dropdown-content">
                                        ...
                                        <a class="scroll-link" title="Disease">
                                            Disease
                                        </a>
        ...
        <section id="feedback" class="contact-parlex">
            <div class="parlex-back">
                <div class="container">
                    ...
                    <div class="row mrgn30">
                        <form method="post" action="create10Success" id="createDiseaseForm1" role="form">
                            <div class="col-sm-4">
                                <div class="search-group">
                                    <label for="diseaseTxt">
                                        Disease:
                                    </label>
                                    <input type="text" class="search-control" name="diseaseTxt" id="diseaseTxt" placeholder="Disease" title="Disease" required>
                                    <button name="diseaseTxtBtn" type="submit" class="btn btn-lg btn-primary" id="diseaseTxtBtn">
                                        Create
                                    </button>
                    ...
                    <div class="row mrgn30">
                        <form method="post" action="update10Success" id="createDiseaseForm2" role="form">
                            <div class="col-sm-4">
                                <div class="search-group">
                                    <table id="myTable" width="1000">
                                        <%for(int i=0; i<list.size(); i++) { id = "diseaseTxt" + Integer.toString(i); idForTd = "td" + Integer.toString(i); idForBtn1 = "td" + Integer.toString(i) + "Btn1"; idForBtn2 = "td" + Integer.toString(i) + "Btn2"; idForBtn3 = "td" + Integer.toString(i) + "Btn3"; idForBtn4 = "td" + Integer.toString(i) + "Btn4";%>
                                        <tr>
                                            <td>
                                                <label for="diseaseTxt">
                                                    Disease: 
                                            ...
                                            <td id="<%= idForTd%>">
                                                <input type="text" class="form-control" name="<%= id%>"  id="<%= id%>" placeholder="Disease" title="Disease" value="<%= list.get(i)%>" required readonly >
                                            </td> 
                                            <td id="<%= idForBtn1%>">
...
//                alert(id2 + ": " + s);
        ...
        function addMore() {
            ...
            cell1.innerHTML = "<label for='diseaseTxt'>Disease: </label>";
            cell2.innerHTML = "<input type='text' class='form-control' name='diseaseTxt' id='diseaseTxt' placeholder='Disease' title='Disease' required >";
            cell2.id = "td" + (x + 1);
...
<!--	<script type="text/javascript">
            function checkForm(form)
            {
                ...
                if(!re.test(form.diseaseTxt.value)) 
                {
